 ...
 * @author NaniXC7
 */
public class Ver_Listado_Pelis extends javax.swing.JFrame {

    /**
     * Creates new form Ver_Listado_Pelis
     */
    public Ver_Listado_Pelis() {
        initComponents();
        
        this.setLocationRelativeTo(null);
        
        this.setTitle("Listado Películas/Series");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, 400, 170));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 200, 110, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Listado_Pelis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
